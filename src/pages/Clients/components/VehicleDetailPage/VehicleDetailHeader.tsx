...
import { FaArrowLeft, FaCar, FaEdit, FaTrash } from 'react-icons/fa';
            ...
            <HeaderMain>
                ...
                <VehicleHeaderInfo>
                    ...
                    <VehicleDetails>
                        ...
                        {vehicle.displayName && (
                            <VehicleDisplayName>{vehicle.displayName}</VehicleDisplayName>
                        )}
                    </VehicleDetails>
...
const VehicleDisplayName = styled.div`
    font-size: 14px;
